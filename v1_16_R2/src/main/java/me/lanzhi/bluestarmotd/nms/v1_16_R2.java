...
public class v1_16_R2 extends VersionManager
{
    ...
    {
        v1_16_R2.infoGetter=infoGetter;
    ...
    private ServerPing parseServerPing()
    {
        ...
        String serverName=MinecraftServer.getServer().getServerModName()+" "+SharedConstants.getGameVersion().getName();
        ping.setServerInfo(new ServerPing.ServerData(info.getServerName()!=null?info.getServerName():serverName,
                                                     info.getServerVersion()?-1:SharedConstants.getGameVersion()
                                                                                               .getProtocolVersion()));
        return ping;
    }
}
