...
public class v1_14_R1 extends VersionManager
{
    ...
    {
        v1_14_R1.infoGetter=infoGetter;
    ...
    private ServerPing parseServerPing()
    {
        ...
        String serverName=MinecraftServer.getServer().getServerModName()+" "+SharedConstants.a().getName();
        ping.setServerInfo(new ServerPing.ServerData(info.getServerName()!=null?info.getServerName():serverName,
                                                     info.getServerVersion()?-1:SharedConstants.a()
                                                                                               .getProtocolVersion()));
        return ping;
    }
}
